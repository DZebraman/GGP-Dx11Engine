...
Blur::Blur(float width, float height, ID3D11Device* _device, ID3D11DeviceContext * _deviceContext, ID3D11SamplerState* _sampler)
{
	device = _device;
...
ID3D11ShaderResourceView* Blur::draw(ID3D11ShaderResourceView* ppSRV, ID3D11DepthStencilView* depthStencilView) {
